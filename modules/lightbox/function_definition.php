...
$FunctionList['canAddItemToLightbox'] = array(
    'name'           => 'canAddItemToLightbox',
    'call_method'    => array( 'include_file' => 'extension/ezlightbox/modules/lightbox/lightboxfunctioncollection.php',
                               'class'        => 'lightboxFunctionCollection',
                               'method'       => 'fetchLightboxItemPermission'
                             ),
    'parameter_type' => 'standard',
    'parameters'     => array( array( 'name'     => 'lightbox',
                                      'type'     => 'misc',
                                      'required' => true
                                    ),
                               array( 'name'     => 'item',
