{if is_object( $user )}
     ...
     <h1>{'Send lightbox "%1" to %2'|i18n( 'design/standard/lightbox/send', , hash( '%1', $lightbox.name, '%2', $user.contentobject.name|wash() ) )}</h1>

{else}

     <h1>{'Send lightbox "%1"'|i18n( 'design/standard/lightbox/send', , hash( '%1', $lightbox.name ) )}</h1>
...
{/if}
      ...
      <table class="align-top">
       <tr>
        <td><label>{'Receiver'|i18n( 'design/standard/lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Subject'|i18n( 'design/standard/lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Body'|i18n( 'design/standard/lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Access'|i18n( 'design/standard/lightbox/send' )}:</label></td>
        <td>
...
{if and( is_object( $user ), $sendout|not() )}
       ...
       <input type="submit" name="SendLightboxButton" value="{'Send lightbox'|i18n( 'design/ezdam/lightbox/create' )}" class="button" />
       <input type="submit" name="SendLightboxBackButton" value="{'Go back'|i18n( 'design/ezdam/lightbox/create' )}" title="{'Use this button to go back.'|i18n( 'design/ezdam/lightbox/create' )}" class="button" />
...
{else}
    ...
    {if $sendout|not()}
       ...
       <input type="submit" name="FindUserButton" value="{'Find user'|i18n( 'design/ezdam/lightbox/create' )}" class="button" />
    ...
    {if and( is_set( $redirectURI ), $redirectURI|ne( '' ) )}
       ...
       <input type="hidden" name="redirectURI" value="{$redirectURI}" />
       <input type="submit" name="GoBackButton" value="{'Go back'|i18n( 'design/ezdam/lightbox/create' )}" title="{'Use this button to go back.'|i18n( 'design/ezdam/lightbox/create' )}" class="button" />
