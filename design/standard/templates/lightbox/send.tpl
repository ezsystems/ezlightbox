...
{if and( is_object( $user ), $sendout|not() )}
       ...
       <input type="submit" name="SendLightboxButton" value="{'Send lightbox'|i18n( 'lightbox/send' )}" class="button" />
       <input type="submit" name="SendLightboxBackButton" value="{'Go back'|i18n( 'lightbox/send' )}" title="{'Use this button to go back.'|i18n( 'lightbox/send' )}" class="button" />
...
{else}
    ...
    {if $sendout|not()}
       ...
       <input type="submit" name="FindUserButton" value="{'Find user'|i18n( 'lightbox/send' )}" class="button" />
    ...
    {if and( is_set( $redirectURI ), $redirectURI|ne( '' ) )}
       ...
       <input type="hidden" name="redirectURI" value="{$redirectURI}" />
       <input type="submit" name="GoBackButton" value="{'Go back'|i18n( 'lightbox/send' )}" title="{'Use this button to go back.'|i18n( 'lightbox/send' )}" class="button" />
