{if is_object( $user )}
     ...
     <h1>{'Send lightbox "%1" to %2'|i18n( 'lightbox/send', , hash( '%1', $lightbox.name, '%2', $user.contentobject.name|wash() ) )}</h1>

{else}

     <h1>{'Send lightbox "%1"'|i18n( 'lightbox/send', , hash( '%1', $lightbox.name ) )}</h1>
...
{/if}
      ...
      <table class="align-top">
       <tr>
        <td><label>{'Receiver'|i18n( 'lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Subject'|i18n( 'lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Body'|i18n( 'lightbox/send' )}:</label></td>
        <td>
...
{/if}
       ...
       <tr>
        <td><label>{'Access'|i18n( 'lightbox/send' )}:</label></td>
        <td>
