...
{if and( is_array( $current_user.role_id_list ), $current_user.role_id_list|count()|gt( 0 )}

    {set $user_hash = $current_user.role_id_list|implode( ',' )}

{/if}

{if and( is_array( $current_user.limited_assignment_value_list ), $current_user.limited_assignment_value_list|count()|gt( 0 )}
