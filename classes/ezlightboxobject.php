...
class eZLightboxObject extends eZPersistentObject
{
    ...
    public static function create( $lightboxID, $itemID, $typeID, $priority = 0 )
    {
        ...
        {
            eZDebug::writeWarning( 'Invalid item ID: ' . $itemID, 'eZLightboxObject::create' );
            return null;
        }*/
    ...
    public static function fetch( $lightboxID, $itemID, $typeID, $asObject = true )
    {
        ...
        {
            eZDebug::writeWarning( 'Invalid item ID: ' . $itemID, 'eZLightboxObject::fetch' );
            return false;
        }
                                          ...
                                          )
    {
        if ( !is_numeric( $itemID ) )
        {
            eZDebug::writeWarning( 'Invalid item ID: ' . $itemID, 'eZLightboxObject::fetchListByItem' );
            return false;
        }
